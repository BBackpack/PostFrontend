...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        const getInfo = async () => {
          ...
          try {
            const response = await axios.post('https://post-backend-2f54f7162fc4.herokuapp.com/customer-info', { 
              userID: userID
            });
      ...
      const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://post-backend-2f54f7162fc4.herokuapp.com/update-info', {
                userID: userID,
                firstName: firstName,
